...
class MainWindow(QMainWindow):
    ...
    def add_new_tab(self, qurl=None, label="Blank"):
        ...
        # Connect a slot to handle the loadFinished signal
    ...
    def on_load_finished(self, browser):
        ...
        browser.page().toHtml(self.parse_html)
    ...
    # Use BeautifulSoup to parse HTML content
        ...
        # Extract the href attribute from each <a> tag to obtain hyperlinks
        hyperlinks = [link.get('href') for link in links if link.get('href') is not None]
        
        # Write hyperlinks to a text file
